...
// Extract the pass type, bus_pass_id, and expiry date from the request
$busPassId = $data['busPassId']; // bus_pass_id to identify which record to update
...
$sql = "UPDATE users SET expiry_date = '$expiryDate' WHERE bus_pass_id = '$busPassId'";
